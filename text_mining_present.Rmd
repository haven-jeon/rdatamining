...
```{r barplot, fig.width=8, fig.height=10, message=FALSE, warning=FALSE}
library(ggplot2)
...
```{r wordcloud,fig.width=8, fig.height=8, message=FALSE, warning=FALSE}
#Word Cloud 
...
```{r hclust,fig.width=7, fig.height=6, message=FALSE, warning=FALSE}
